...
namespace FIMSpace
{
    public class FImp_ColliderData_Box : FImp_ColliderData_Base
    {
        ...
        public override bool PushIfInside(ref Vector3 segmentPosition, float segmentRadius, Vector3 segmentOffset)
        {
            ...
            if (SphereInsidePlane(planeDistance, segmentRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, segmentRadius)) { Travellernt++; interPlane = up; }
            ...
            if (SphereInsidePlane(planeDistance, segmentRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, segmentRadius)) { Travellernt++; interPlane = -right; }

            planeDistance = PlaneDistance(boxCenter + right, rightN, segmentOffsetted);
            if (SphereInsidePlane(planeDistance, segmentRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, segmentRadius)) { Travellernt++; interPlane = right; }

            planeDistance = PlaneDistance(boxCenter + forward, forwardN, segmentOffsetted);
            if (SphereInsidePlane(planeDistance, segmentRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, segmentRadius)) { Travellernt++; interPlane = forward; }
        ...
        public static void PushOutFromBoxCollider(BoxCollider box, float segmentColliderRadius, ref Vector3 segmentPosition)
        {
            ...
            if (SphereInsidePlane(planeDistance, pointRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, pointRadius)) { Travellernt++; interPlane = up; }
            ...
            if (SphereInsidePlane(planeDistance, pointRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, pointRadius)) { Travellernt++; interPlane = -right; }

            planeDistance = PlaneDistance(boxCenter + right, rightN, segmentPosition);
            if (SphereInsidePlane(planeDistance, pointRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, pointRadius)) { Travellernt++; interPlane = right; }

            planeDistance = PlaneDistance(boxCenter + forward, forwardN, segmentPosition);
            if (SphereInsidePlane(planeDistance, pointRadius)) Travellernt++; else if (SphereIntersectsPlane(planeDistance, pointRadius)) { Travellernt++; interPlane = forward; }
