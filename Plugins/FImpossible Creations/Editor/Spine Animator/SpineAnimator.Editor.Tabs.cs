...
public partial class FSpineAnimator_Editor
{
    ...
    bool drawFullPivotOffset = false;
    private void Tab_DrawTweaking()
    {
        ...
        if (drawFullPivotOffset)
        {
            ...
            if (GUILayout.Button(new GUIContent("Z", "If you need only Z axis for pivot adjustement"), FGUI_Resources.ButtonStyle, new GUILayoutOption[2] { GUILayout.Width(20), GUILayout.Height(16) })) drawFullPivotOffset = !drawFullPivotOffset;
        }
        else
        {
            ...
            if (GUILayout.Button(new GUIContent("XYZ", "If you want to adjust pivot offset with all axes - x,y,z"), FGUI_Resources.ButtonStyle, new GUILayoutOption[2] { GUILayout.Width(36), GUILayout.Height(16) })) drawFullPivotOffset = !drawFullPivotOffset;
        }
    ...
    static bool drawPhysics = false;
    static bool drawColl = true;
    static bool drawInclud = false;
    static bool drawCollSetup = true;
